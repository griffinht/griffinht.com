...
X=MsgBox("To prevent machine from shutting down, give Windows Command Processor permission to run",0+64,"Windows Security") 
CreateObject("WScript.Shell").Run("""shutdownlnk.bat""")